    ...
    <AppShell>
      <div className="space-y-8">
        ...
        <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          {/* ⬇️ Right side: now sized to buttons, not full width */}
          <div className="flex flex-col gap-3 items-end w-full lg:w-auto">
            {/* Top Tabs for Executive Dashboard */}
            <div className="inline-flex items-center justify-end gap-2 bg-white/60 border border-gray-200 rounded-full px-1 py-1 shadow-sm">
              <button
